...
echo -e "vmess://\c"
echo '{"v": "2", "ps": "", "add": "DOMAIN", "port": "443", "id": "UUID", "aid": "64", "scy": "none", "net": "ws", "type": "none", "host": "", "path": "PATH", "tls": "tls", "sni": "DOMAIN"}' | sed -e "s@DOMAIN@${domain}@" -e "s@DOMAIN@${domain}@" -e "s@PATH@${path}@" -e "s@UUID@${uuid}@" | base64
